...
export class CadeauListComponent implements OnInit {
  cadeauList= [
    {
      nom: 'Peluche caline',
      description: 'Une peluche à la fois douce et effrayante, elle marche, parle et fonctionne sans pile',
      prix: 25,
      image: 'https://i.etsystatic.com/iap/49e108/2440001545/iap_300x300.2440001545_ptv5ahvz.jpg?version=0',
    },
    {
